...
#define DEFAULT_DIFFUSE 0.9f
#define DEFAULT_SPECULAR 0.9f
#define DEFAULT_SHININESS 200.0f
...
t_tuple ray_origin(const t_ray *r);
t_tuple ray_direction(const t_ray *r);
