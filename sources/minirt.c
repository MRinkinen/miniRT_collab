...
/*   Updated: 2024/08/16 11:25:27 by mrinkine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color ray_color(const t_ray *r, hittable_list *world, t_vec3 camera_pos)
{
	...
	background = t_color_create(0.0, 0.0, 0.0);
...
void printimage(void *param)
{
	...
	t_sphere s1 = sphere_create(t_vec3_create(50, 50, -200), 20, t_color_create(100, 100, 100));
